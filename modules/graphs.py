...
def graph_tested_lab():
    filename = "./graphs/no_tested_lab.png"
    if os.path.exists(filename):
        os.remove(filename)

    data = c19norge.timeseries("tested_lab")
...
def graph_hospitalized():
    data = c19norge.timeseries("hospitalized")
    today = date.today()
...
def graph_smittestopp():
    data = c19norge.timeseries("smittestopp")
